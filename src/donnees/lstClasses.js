...
export const nomMagusTzeentch = 'Magus du culte de Tzeentch'
...
export const nomAcolyteDuCulte = 'Acolyte du culte'
export const nomMagusDuCulte = 'Magus du culte'
export const nomMaitreMagus = 'Maître magus'
...
export const lstClasses = [
        ...
        evolutions: [
          ...
          },
          {
            ...
            talents: [
              nomDoueEnCalcul,
              nomSavoirVivreErudits,
              nomTravailleurQualifieIngenierie,
              nomTireurEmbusque,
            ]
          },
          {
      ...
      },
      {
        ...
        evolutions: [
          ...
          },
          {
            ...
            talents: [
              nomMagieDesArcanesDomaineAuChoix,
              nomDetectionDArtefacts,
              nomMainsAgiles,
              nomSixiemeSens,
            ]
          },
        ...
        evolutions: [
          ...
          },
          {
            ...
            talents: [
              nomNageurEndurant,
              nomPilote,
              nomSansPeurPatrouilleursFluviaux,
              nomSuborneur,
            ]
          },
          {
      ...
      },
      {
        ...
        evolutions: [
          ...
          },
          {
            ...
            talents: [
              nomInfatigable,
              nomMaitreArtisanConstructeurDeBateaux,
              nomMarinier,
              nomSociable,
            ]
          },
          ...
          },
          {
            ...
            talents: [
              nomObstine,
              nomOrateur,
              nomTravailleurQualifieConstructeurDeBateaux,
              nomVivacite,
            ]
          },
        ],
  ...
  },
  {
    ...
    carrieres: [
      ...
      {
        titre: nomMagusTzeentch,
        description: 'Magus de Tzeentch',
        evolutions: [
          {
            titre: nomAcolyteDuCulte,
            statut: {
              echelon: bronze,
              standing: 1,
            },
            caracs: [nomInitiative, nomForceMentale, nomIntelligence],
            competences: [
              nomDivertissementInterpretation,
              nomDiscretionUrbaine,
              nomFocalisationDhar,
            ...
            talents: [
              nomInsignifiant,
              nomIdentiteSecrete,
              nomBenedictionDeTzeentch,
              nomPerceptionDeLaMagie,
              nomMagieMineure,
            ]
          },
          {
            titre: nomMagusDuCulte,
            statut: {
              echelon: argent,
              standing: 4,
            },
          ...
          },
          {
            ...
            talents: [
              nomDiscipleDuChangement,
              nomGrandOrateur,
              nomMagieDesArcanesDemonologie,
              nomMaitreEnDeguisement,
            ]
          },
          {
            titre: nomMaitreMagus,
            statut: {
              echelon: or,
              standing: 2,
            },
