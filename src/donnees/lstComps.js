...
export const nomChevaucherBlaireau = 'Chevaucher (Blaireau)'
...
export const nomDiscretionRurale = 'Discrétion rurale'
...
export const nomDivertissementProphetie = 'Divertissement (prophétie)'
...
export const nomDivertissementVoyance = 'Divertissement (voyance)'
export const nomDressage = 'Dressage (au choix)'
export const nomDressageChien = 'Dressage de chien'
export const nomDressageBlaireau = 'Dressage de blaireau'
...
export const nomFocalisationAzyr = 'Focalisation (Azyr)'
export const nomFocalisationDhar = 'Focalisation (Dhar)'
...
export const nomLangueObscure = 'Langue obscure'
export const nomLangueVoleur = 'Langue (voleur))'
export const nomLangueEstalienTileen = 'Langue (estalien ou tiléen)'
export const nomLangueSombre = 'Langue sombre'
...
export const nomMetierGraveur = 'Graveur'
...
export const nomMetierExplosifs = 'Métier (explosifs)'
export const nomMetierCartographe = 'Cartographe'
...
export const nomSavoirDemonologie = 'Savoir (démonologies)'
export const nomSavoirLeMoot = 'Savoir (Le moot)'
...
export const nomSavoirFolklore = 'Savoir (folklore)'
...
export const nomSavoirHerbes = 'Savoir (herbes)'
export const nomSavoirHistoire = 'Savoir (histoire)'
export const nomSavoirDragons = 'Savoir (dragons)'
export const nomSavoirNecromancie = 'Savoir (nécromancie)'
export const nomSavoirGuerre = 'Savoir (guerre)'
export const nomSavoirUlric = 'Savoir (Ulric)'
export const nomSavoirGeants = 'Savoir (géants)'
export const nomSavoirGenealogie = 'Savoir (généalogie)'
export const nomSavoirGeologie = 'Savoir (géologie)'
...
export const nomSavoirArtGuerre = 'Savoir (art de la guerre)'
export const nomSavoirAuChoix = 'Savoir (au choix)'
...
export const nomSavoirAstrologie = 'Savoir (astrologie)'
export const nomSavoirBetes = 'Savoir (bêtes)'
...
export const nomSavoirProphetie = 'Savoir (prophétie)'
...
export const nomSavoirEpaves = 'Savoir (épaves)'
export const nomSavoirEsprits = 'Savoir (esprits)'
...
export const nomSavoirMagieNoire = 'Savoir (Magie noire)'
...
export const nomSavoirTzeentch = 'Savoir (Tzeentch)'
...
export const nomSignesSecretsCulte = 'Signes secrets de culte'
export const nomSignesSecretsMineurs = 'Signes secrets de mineurs'
